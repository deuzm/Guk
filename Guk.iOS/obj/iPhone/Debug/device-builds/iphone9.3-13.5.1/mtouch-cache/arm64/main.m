...
extern void *mono_aot_module_Guk_iOS_info;
...
extern void *mono_aot_module_Guk_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Newtonsoft_Json_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Guk_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Guk_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Guk.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
